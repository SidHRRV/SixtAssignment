...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, Taxi> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(Taxi.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Taxi> userKafkaListenerFactory() {
